...
/**
 * -----------------------------------------------------------------------------------
 * User clicks the "Low Quality Image" button
 * -----------------------------------------------------------------------------------
 * */  
$("#lq").on("click", function() {
    //#region
    // addImage("low-quality.png");
    addImage("/image-quality/low-quality.png");
...
/**
 * -----------------------------------------------------------------------------------
 * User clicks the "High Quality Image" button
 * -----------------------------------------------------------------------------------
 * */  
...
/**
 * -----------------------------------------------------------------------------------
 * User clicks the "Vector Image" button
 * -----------------------------------------------------------------------------------
 * */  
...
function addImage(url) {
    ...
    Konva.Image.fromURL(url, function (imgNode) { // <- This line is for GitHub's relative link
        ...
        // Print inital things to the DOM
...
/**
 * -----------------------------------------------------------------------------------
 * Calculate the percentage increase, and print data to the DOM 
 * -----------------------------------------------------------------------------------
 * */
function printNodeData(imgNode) {
        // Figure out scale of current canvas size in relation to target output size
        // This can be variable
        var cnvWidth = stage.width();

        // What is the scale of the current stage in relation to the final output we are going for?
        var scaleFactor = outputWidth / cnvWidth;

        // console.log(scaleFactor);
        // var nodeWidth = imgNode.width();
        var finalNodeWidth = (imgNode.width() * imgNode.scaleX()) * scaleFactor; // <-- Output Width
        var finalNodeHeight = (imgNode.height() * imgNode.scaleX()) * scaleFactor; 

        // What is the percentage increase of finalNodeWidth from nodeWidth (original size)
        /*
